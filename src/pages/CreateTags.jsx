   ...
   return (
      <div className="w-full h-full flex justify-center items-center p-8 my-8">
         <div className="flex flex-col w-full justify-center md:flex-row mt-[4em]">
            ...
            {/* 左侧导航 */}
            <div className="w-full md:w-[200px] h-auto md:h-[700px] flex flex-col space-y-4 p-4 bg-opacity-50 rounded-3xl text-white mb-4 md:mb-0 md:mr-4 overflow-y-auto custom-scrollbar">
          ...
          hover:shadow-[0_0_0_2px_#BE7123]`}
            ...
            {/* 卡片 */}
            <div className="w-full md:w-[460px] h-auto md:h-[700px] flex flex-col items-center justify-center">
               <div className="w-full md:w-[460px] h-auto md:h-[700px] flex flex-col p-7 justify-center items-center shadow-lg rounded-3xl bg-clip-padding bg-opacity-5 border-2 border-[#BE7123] backdrop-blur-[5px]">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4 w-full">
                     ...
                     <div className="bg-opacity-5 w-full md:w-[400px] h-auto md:h-[500px] mb-9 border border-[#BE7123] text-gray-700 rounded-2xl overflow-hidden shadow-lg relative flex flex-col p-4 overflow-y-auto custom-scrollbar">
