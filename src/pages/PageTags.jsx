    ...
    <div className="pt-[118px]">
      <PanelBox title="Create Your Tags">
        <div className="flex justify-center">
          {categories.map((item) => (
            <div className="flex justify-center w-[180px] mx-[10px] px-[32px] py-[8px] rounded-[8px] border border-[#FFFFFF33] text-white text-[18px] hover:bg-btngreen cursor-pointer">
              {item}
            </div>
          ))}
        </div>
        <div className="flex items-center py-[40px]">
          ...
          <div className="mx-[72px] text-[#FFFFFF8A]">Please Select Tags</div>
          <div className="flex-1 w-full h-[1px] bg-[#ffffffa3]"></div>
        </div>
        <div className="grid grid-cols-3 gap-x-[30px] gap-y-[30px] w-[690px] text-[#FFFFFF8A]">
